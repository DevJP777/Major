...
// const colors = require('colors'); // Menggunakan colors
...
//                 } catch (error) {
//                     console.error(colors.red('Error parsing JSON:'), error.message);
//                     return;
//                 }
...
//                 console.log(`Task akan dijalankan ulang dalam waktu: ${yellowText(formattedInterval)}`);
//                 console.log(`Script Created By: ${yellowText('DEVJP777')}`)

//                 // Tunggu sebelum menjalankan tugas lagi
